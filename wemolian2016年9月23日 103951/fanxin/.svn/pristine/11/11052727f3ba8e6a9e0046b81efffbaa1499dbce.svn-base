...
public class ShowAllPhoto extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mContext = this;
		back = (ImageView) findViewById(R.id.showallphoto_back);
	...
	private class PreviewListener implements OnClickListener {
		public void onClick(View v) {
			if (Bimp.tempSelectBitmap.size() > 0) {
				Toast.makeText(getApplicationContext(), "showAllPhoto 90 -->GalleryActivity", Toast.LENGTH_SHORT).show();
				Log.i("位置", "showAllPhoto 90 -->GalleryActivity");
				...
				.setOnItemClickListener(new AlbumGridViewAdapter.OnItemClickListener() {
					public void onItemClick(final ToggleButton toggleButton,
						...
						if (Bimp.tempSelectBitmap.size() >= PublicWay.num&&isChecked) {
							...
							Toast.makeText(ShowAllPhoto.this, "超出可选图片张数", 200)
									.show();
							return;
						}
