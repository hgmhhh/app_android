...
import com.wemolian.app.lock.view.LockPatternView;
import com.wemolian.app.lock.view.LockPatternView.Cell;
import com.wemolian.app.lock.view.LockPatternView.DisplayMode;
...
public class CreateGesturePasswordActivity extends BaseActivity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.lock_hand_create);
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		if (keyCode == KeyEvent.KEYCODE_BACK && mUiStage == Stage.Introduction) {
			updateStage(Stage.HelpScreen);
			return true;
		}
...
//		App.getInstance().getLockPatternUtils().saveLockPattern(mChosenPattern);
		WeMoLianApplication.getInstance().getLockPatternUtils().saveLockPattern(mChosenPattern);
		showToast("手势密码设置成功");
