...
import com.wemolian.app.wml.others.ConversationAdapter;
...
public class FragmentCoversation extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        listFootView = LayoutInflater.from(getActivity()).inflate(R.layout.item_service_and_feedback, null);
...
//				Toast.makeText(getActivity(), "服务与帮助", Toast.LENGTH_SHORT).show();
