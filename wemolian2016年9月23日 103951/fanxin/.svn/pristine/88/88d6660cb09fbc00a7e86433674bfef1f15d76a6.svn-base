 ...
 */
package com.wemolian.applib.model;
...
import com.wemolian.applib.utils.HXPreferenceUtils;
...
//    private static final String PREF_USERNAME = "username";
    private static final String PREF_USERNAME = "externalUse";
    ...
    public String getHXId() {
        // TODO Auto-generated method stub
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        String id = preferences.getString(PREF_USERNAME, null);
        return id;
    }
