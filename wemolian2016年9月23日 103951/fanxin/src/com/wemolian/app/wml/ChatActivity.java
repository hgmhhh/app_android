...
import com.wemolian.app.activity.ForwardMessageActivity;
import com.wemolian.app.activity.ImageGridActivity;
import com.wemolian.app.activity.VoiceCallActivity;
import com.wemolian.app.adapter.ExpressionAdapter;
import com.wemolian.app.adapter.ExpressionPagerAdapter;
import com.wemolian.app.adapter.MessageAdapter;
import com.wemolian.app.adapter.VoicePlayClickListener;
...
//
            ...
            iv_setting_group.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    startActivityForResult((new Intent(ChatActivity.this,
                            ChatRoomSettingActivity.class)
                            .putExtra("groupHxId",toChatUsername)
    ...
    public void selectPicFromCamera() {
        ...
        cameraFile = new File(PathUtil.getInstance().getImagePath(),
                WeMoLianApplication.getInstance().getUserName()
...
//              message.setAttribute("toUserAvatar", toUserAvatar);
            message.setAttribute(LocalDBKey.CONTACTS_COLUMN_NAME_IMGNAME, myUserAvatar);
            message.setAttribute(LocalDBKey.CONTACTS_COLUMN_NAME_LABEL, myUserNick);
//            message.setAttribute("usernick", "test");
            // 把messgage加到conversation中
            //msg{from:11242979, to:11242904 body:txt:"adsad"
                ...
                try {
                    ...
                    if (buttonSetModeKeyboard.getVisibility() != View.VISIBLE) {
                        ...
                        if (filename != "delete_expression") { // 不是删除键，显示表情
                            ...
                            Class clz = Class
                                    .forName("com.wemolian.app.utils.SmileUtils");
