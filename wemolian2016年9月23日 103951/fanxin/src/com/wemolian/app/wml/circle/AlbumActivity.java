...
import com.wemolian.app.video.util.AlbumHelper;
...
import com.wemolian.app.wml.circle.adapter.AlbumGridViewAdapter;
...
public class AlbumActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		IntentFilter filter = new IntentFilter("data.wemolian.action");  
...
//				Toast.makeText(getApplicationContext(), "预览功能正在开发中", Toast.LENGTH_SHORT).show();
	...
	private class AlbumSendListener implements OnClickListener {
		...
		public void onClick(View v) {
			...
			case "AddCircleMianMianActivity":
				intent.setClass(mContext, AddCircleMianMianActivity.class);
				startActivity(intent);
				finish();
				break;
...
//			intent.setClass(mContext, AlbumActivity.class);
			...
			switch (activity) {
			case "AddCircleMianMianActivity":
				intent.setClass(AlbumActivity.this, AddCircleFriendActivity.class);
				startActivity(intent);
				break;
			case "AddCircleFriendActivity":
				intent.setClass(AlbumActivity.this, AddCircleMianMianActivity.class);
				startActivity(intent);
				break;
			}
