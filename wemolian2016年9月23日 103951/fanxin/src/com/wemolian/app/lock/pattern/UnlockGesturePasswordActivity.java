...
public class UnlockGesturePasswordActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.lock_hand_unlock);
	...
	protected void onResume() {
		...
		if (!WeMoLianApplication.getInstance().getLockPatternUtils().savedPatternExists()) {
	...
	protected LockPatternView.OnPatternListener mChooseNewLockPatternListener = new LockPatternView.OnPatternListener() {
		...
		public void onPatternDetected(List<LockPatternView.Cell> pattern) {
			if (pattern == null)
				return;
			if (WeMoLianApplication.getInstance().getLockPatternUtils().checkPattern(pattern)) {
				mLockPatternView
